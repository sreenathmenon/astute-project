...
from openstack_dashboard.dashboards.project.access_and_security.floating_ips \
    import workflows
from astutedashboard.dashboards.project.instances import tabs
...
from astutedashboard.common import \
    disassociate_plan_mapping_with_instance
...
class TerminateInstance(policy.PolicyTargetMixin, tables.BatchAction):
    ...
    def action(self, request, obj_id):
        ...
        plan = server.metadata.get('plan')
        if plan:
            disassociate_plan_mapping_with_instance(request, plan)
