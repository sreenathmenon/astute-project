...
from astutedashboard.dashboards.admin.volumes.volume_types.extras \
    import urls as extras_urls
from astutedashboard.dashboards.admin.volumes.volume_types.qos_specs \
    import urls as qos_specs_urls
from astutedashboard.dashboards.admin.volumes.volume_types \
    import views

VIEWS_MOD = ('astutedashboard.dashboards.admin.volumes.volume_types.views')
